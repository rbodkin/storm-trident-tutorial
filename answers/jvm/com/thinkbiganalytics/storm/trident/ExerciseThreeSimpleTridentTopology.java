...
public class ExerciseThreeSimpleTridentTopology {

    public static class Constant extends BaseFunction {
    ...
    public static StormTopology buildTopology( LocalDRPC drpc ) {
        ...
        //
        		...
        		.each(new Fields("symbol"), new Constant("*"), new Fields("aggregate"))
        		
                // -- fields grouping by "symbol"
                .groupBy( new Fields( "aggregate" ) )
        ...
        //
                ...
                .each( new Fields( "args" ), new Constant("*"), new Fields( "aggregate" ) )
                //
                ...
                .stateQuery( tradeVolume, new Fields( "aggregate" ), new MapGet(), new Fields( "volume" ) )
