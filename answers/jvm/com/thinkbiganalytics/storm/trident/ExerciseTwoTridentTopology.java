...
public class ExerciseTwoTridentTopology {

    private static final int DRPC_QUERY_ITERATIONS = 2000;
    private static final int DRPC_QUERY_INTERVAL = 600;
    ...
    public static StormTopology buildTopology( LocalDRPC drpc ) {
        ...
        //
                ...
                .each( new Fields( "volume"), new StockVolumeFilter( 1000000 ) )
                ...
                // Project only the stock symbol with total volume over 10k
                .project( new Fields( "symbol") );
