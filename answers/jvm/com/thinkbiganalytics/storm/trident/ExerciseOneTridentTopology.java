 ...
 */
public class ExerciseOneTridentTopology {

    public static class RoundFunction extends BaseFunction {

		@Override
		public void execute(TridentTuple tuple, TridentCollector collector) {
			collector.emit(new Values(new Double(Math.round(tuple.getDoubleByField( "price" )))));
		}
    ...
    public static StormTopology buildTopology( LocalDRPC drpc ) {
        ...
        //
        		.each(fields, new RoundFunction(), new Fields("dollar_price"))

                // debug display fields values.
                //.each( new Fields("dollar_price","price"), new Debug() )
                //
                 ...
                 */
                .persistentAggregate( mapState, new Fields("dollar_price","price","symbol","shares"), new StockAggregatorRounded(), new Fields( "stats" ) );
